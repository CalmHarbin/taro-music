  ...
  render() {
    return (
      <View className='Recommend'>
            ...
            return (
              <SwiperItem key={index}>
                <Image
                  lazyLoad
                  style=''
                  src={this.state.show.includes(index) ? item + '?imageView&thumbnail=480x0' : ''}
                />
              </SwiperItem>
            );
          })}
        ...
        {/* 推荐歌单 */}
        <View onClick={this.go.bind(this, '推荐歌单')} className='cell-title'>
          推荐歌单
        ...
        {/* 排行榜 */}
        <View onClick={this.go.bind(this, '排行榜')} className='cell-title'>
          排行榜
          <AtIcon value='chevron-right' size='20' color='#999' />
        </View>
        <View className='cell-SongSheet'>
